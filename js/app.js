(() => {
  ...
  let e = (e, t = 500, o = 0) => {
    ...
    s = (e = 0) => {
      ...
      const t = document.querySelector("body"),
        s = document.querySelectorAll("[data-lp]");
      (setTimeout(() => {
        (s.forEach((e) => {
  ...
  const l = {};
  window.flsModules = window.flsModules || l;
  const a = new (class {
    constructor(e) {
      let t = {
        logging: !0,
  ...
  const u = document.querySelector(".header"),
    p = () => {
      window.scrollY > 0
        ? u.classList.add("header_scrolled")
        : u.classList.remove("header_scrolled");
    };
  (window.addEventListener("scroll", p),
    p(),
    document.addEventListener("DOMContentLoaded", () => {
      const e = document.createElement("div");
      e.classList.add("image-popup-overlay");
      const t = document.createElement("button");
      ((t.type = "button"),
        t.classList.add("image-popup-overlay__close", "_icon-close"),
        t.setAttribute("aria-label", "Закрыть"),
        e.appendChild(t),
      ...
      (document.querySelectorAll(".enlargeable-img").forEach((o) => {
        o.addEventListener("click", () => {
          ...
          ((e.innerHTML = ""),
            ...
            (a = 0),
            (c = 0),
            (n.style.transform = `translate(0, 0) scale(${s})`),
        ...
        e.addEventListener("touchstart", (e) => {
          if (2 === e.touches.length && i) n = d(e.touches);
          else if (1 === e.touches.length && i && s > 1) {
            const t = e.touches[0];
            ((r = t.pageX - a), (l = t.pageY - c));
          }
        }),
        e.addEventListener("touchmove", (e) => {
          if (2 === e.touches.length && i) {
            const t = d(e.touches) / n,
              o = Math.max(1, Math.min(t, 3));
            (1 === o && ((a = 0), (c = 0)),
              (s = o),
              (i.style.transform = `translate(${a}px, ${c}px) scale(${s})`));
          } else if (1 === e.touches.length && i && s > 1) {
            const t = e.touches[0];
            ((a = t.pageX - r), (c = t.pageY - l));
            const o = (i.offsetWidth * (s - 1)) / 2,
              n = (i.offsetHeight * (s - 1)) / 2;
            ((a = Math.min(Math.max(a, -o), o)),
              (c = Math.min(Math.max(c, -n), n)),
              (i.style.transform = `translate(${a}px, ${c}px) scale(${s})`));
          }
        }),
    ...
    (function () {
      ...
      (e &&
        ...
        document.addEventListener("click", (t) => {
          if (!i.classList.contains("menu-open")) return;
          if (window.innerWidth < 1470) return;
          r?.contains(t.target) ||
            e?.contains(t.target) ||
            (s(), i.classList.remove("menu-open"));
        }));
    })(),
    (function () {
